<?php
/**
 * Default Russian Lexicon Entries for AjaxFileUpload
 *
 * @package ajaxfileupload
 * @subpackage lexicon
 */
$_lang['ajaxfileupload.uploadButton'] = 'Загрузить';
$_lang['ajaxfileupload.dragZone'] = 'Перетащите файл сюда для загрузки';
$_lang['ajaxfileupload.cancelButton'] =  'Отмена';
$_lang['ajaxfileupload.retryButton'] = 'Повторить';
$_lang['ajaxfileupload.failUpload'] =  'Ошибка загрузки';
